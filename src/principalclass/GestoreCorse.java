...
public class GestoreCorse {
    ...
    /**
     * termina la corsa associata all'utente assegnando eventuali multe o penalit� e facendo pagare la corsa all'utente
     * @param Corsa c 
    ...
    /**
     * questo metodo si occupa di assegnare eventuali multe o penalit� al cliente
     * @param corsa: Corsa
     * @param client : Cliente 
     */
    ...
    /**
     * Questo metodo ritorna l'insieme di clienti che hanno una corsa attiva da pi� di 24 ore
     * @return
     */
    ...
    /**
     * Se � attiva una corsa associata al Cliente c viene restituita quella corsa altrimenti viene restituito null
     * @param c
     * @return
     */
    ...
    /**
     * data una bicicletta, se � associata una corsa attiva viene restituita quella corsa
     * @param b
     * @return Corsa
     */
