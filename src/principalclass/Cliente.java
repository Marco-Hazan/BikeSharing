 ...
 * Ogni cliente inoltre ha anche un attributo di debito che indica il debito eventuale al servizio, un attributo booleano che indica se � uno studente
 * oppure no e un attributo di penalit� che indica quante penalit� sono state assegnate a lui.
 */
public class Cliente extends Utente {
     ...
     * Il tipo di abbonamento viene estratto da AbbonamentoFactory e perci� viene ritornato uno dei suoi attributi statici che indicano il tipo di
     * abbonamento
     * @return String
     */
