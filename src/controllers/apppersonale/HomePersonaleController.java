...
public class HomePersonaleController {
    ...
    void guardaStatistiche(ActionEvent event) {
		...
		statistiche_container.getChildren().add(new Label("Rastrelliera pi� usata in partenza: "+Statistiche.getRPartenzaPiuUsata()));
		statistiche_container.getChildren().add(new Label("Rastrelliera pi� usata in arrivo: "+Statistiche.getRPartenzaPiuUsata()));
		...
		statistiche_container.getChildren().add(new Label("Tipo di bicicletta pi� usata: "+Statistiche.getTipoPiuUsato()));
    }
