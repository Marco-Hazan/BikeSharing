 ...
 * Esso perci� ha durata una settimana (1440*7 minuti) ed ha costo di 9 �
 * 
 *
 */
public class AbbonamentoSettimanale extends Abbonamento {
	 ...
	 * dal momento che l'abbonamento � cominciato la differenza tra end e start deve essere di una settimana,
