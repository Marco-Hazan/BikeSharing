 ...
 * Esso perciò ha durata un anno (1440*7*52 minuti) ed ha costo di 36 €
 * 
 *
 */
...
public class AbbonamentoAnnuale extends Abbonamento {
	 ...
	 * dal momento che l'abbonamento è cominciato la differenza tra end e start deve essere di un anno,
