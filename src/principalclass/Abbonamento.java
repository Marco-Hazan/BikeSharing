...
public abstract class Abbonamento {
	 ...
	 * getStart() e getEnd() non possono ritornare valori nulli quando l'abbonamento non � ancora cominciato, ma dal momento che comincia
	...
	/**
	 * restituisce un valore booleano che indica se l'abbonamento � finito oppure no, e per finito si intende se
	...
	/**
	 * restiuisce un valore booleano che indica se l'abbonamento � ancora in corso (ovvero � cominciato e non � finito)
	 * @return
	 */
