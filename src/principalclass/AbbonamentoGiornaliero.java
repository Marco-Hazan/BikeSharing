 ...
 * Esso perci� ha durata un giorno (1440 minuti) ed ha costo di 4.5 �
 * 
 *
 */
...
public class AbbonamentoGiornaliero extends Abbonamento {
	 ...
	 * dal momento che l'abbonamento � cominciato la differenza tra end e start deve essere di un giorno,
