...
public class Corsa {
     ...
     * end e rastrelliera_end invece possono essere nulli se la corsa non � ancora finita.
     * Se end � nullo anche rastrelliera_end deve essere nullo e viceversa.
     */
    ...
    /**
     * restituisce valore booleano che indica se la corsa � finita oppure no
     * @return
     */
    ...
    /**
     * resttuisce un valore booleano che indica se la corsa � stata multata oppure no
     * @return boolean
     */
     ...
     * Se la corsa non � finita viene calcolato il minutaggio da adesso al timestamp di inizio corsa senn� viene calcolato il minutaggio
    ...
    /**
     * restituisce un valore booleano che indica se la corsa � finita da meno di 5 minuti
     * @return boolean
     */
    ...
    /**
     * restituisce prezzo della corsa. Se il cliente associato a @this � uno studente e la bicicletta associata a @this viene ritornato 0.
     * @return double
     */
    ...
    /**
     * restituisce un valore booleano che indica se la corsa � finita da pi� di 2 ore
     * @return boolean
     */
    ...
    /**
     * restituisce un valore booleano che indica se la corsa � finita da pi� di 24 ore
     * @return boolean
     */
    ...
    /**
     * restituisce il tipo di bici associata a @this. Il valore di ritorno � una stringa che viene specificata in un attributo di BiciclettaFactory
